...
<<<<<<< HEAD:codify/html/list_course/coursehtml.html
        <div class="course-item" style="background-color: #2B187C; color: white;">
            <input type="checkbox" id="checkbox6" class="checkbox">
            <label for="checkbox6"></label>
...
>>>>>>> origin/laravel:resources/views/list_course/coursehtml.blade.php
    </div>
