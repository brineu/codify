...
<<<<<<< HEAD:codify/html/quis/eksepsi/quize9.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize9.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Bagaimana cara memberikan nilai default pada parameter fungsi?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Dengan menggunakan tanda "!"</span>
                </label>
            </div>
        </div>
