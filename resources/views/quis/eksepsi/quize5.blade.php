...
<<<<<<< HEAD:codify/html/quis/eksepsi/quize5.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize5.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize5.blade.php
    ...
    <div class="question">
        <p class="question-text">5. Bagaimana cara mendefinisikan pengecualian kustom di Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">define CustomException:</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">class CustomException(Exception):</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">exception CustomException:</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">try CustomException:</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
