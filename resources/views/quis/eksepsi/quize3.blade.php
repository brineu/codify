...
<<<<<<< HEAD:codify/html/quis/eksepsi/quize3.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize3.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize3.blade.php
    ...
    <div class="question">
        <p class="question-text">3. Bagaimana cara mendefinisikan fungsi dengan parameter di Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">def my_function:</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">def my_function(parameters):</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
