...
<<<<<<< HEAD:codify/html/quis/eksepsi/quize6.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize6.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/eksepsi/quize6.blade.php
    ...
    <div class="question">
        <p class="question-text">6. Fungsi di Python mengembalikan nilai menggunakan pernyataan apa?</p>
    </div>
