...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/boot/quizb5.html
...
>>>>>>> origin/laravel:resources/views/quis/boot/quizb5.blade.php
    ...
    <div class="question">
        <p class="question-text">5. Mana yang bukan merupakan jenis tombol pada Bootstrap?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Default</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Success</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Warning</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
