...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/boot/quizb9.html
...
>>>>>>> origin/laravel:resources/views/quis/boot/quizb9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Apa yang dimaksud dengan "Breadcrumb" dalam Bootstrap?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Roti tawar khusus</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Navigasi berbasis hierarki</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Kartu identitas</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Jenis kue</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
