...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/boot/quizb3.html
...
>>>>>>> origin/laravel:resources/views/quis/boot/quizb3.blade.php
    ...
    <div class="question">
        <p class="question-text">3. Apa fungsi dari kelas "btn" dalam Bootstrap?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Membuat garis batas pada elemen</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Membuat tombol</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Memberikan warna latar belakang</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
