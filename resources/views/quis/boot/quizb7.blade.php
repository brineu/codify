...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/boot/quizb7.html
...
>>>>>>> origin/laravel:resources/views/quis/boot/quizb7.blade.php
    ...
    <div class="question">
        <p class="question-text">7. Apa fungsi dari "Collapse" dalam Bootstrap?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Menyembunyikan & menampilkan konten</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Menjatuhkan ke bawah</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Memperkecil ukuran elemen</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <script>
        ...
        function goToNextPage() {
            var nextUrl = "{{ route('quiz.bs', ['quizNumber' => $quizNumber + 1]) }}";
