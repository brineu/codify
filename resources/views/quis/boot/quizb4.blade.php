...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/boot/quizb4.html
...
>>>>>>> origin/laravel:resources/views/quis/boot/quizb4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Apa yang dimaksud dengan "Accordion" dalam Bootstrap?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Alat musik</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Menampilkan konten terlipat</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Cara mengatur teks berdasarkan abjad</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Gaya menulis berita</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
