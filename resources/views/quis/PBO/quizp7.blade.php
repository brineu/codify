...
>>>>>>> origin/laravel:resources/views/quis/PBO/quizp7.blade.php
    ...
    <div class="question">
        <p class="question-text">7. Manakah dari berikut yang merupakan contoh objek dalam Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">If statement</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
