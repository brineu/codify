...
>>>>>>> origin/laravel:resources/views/quis/PBO/quizp9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Di Python, semua hal dianggap sebagai objek. Apa itu objek?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Struktur data</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Instance dari class</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
