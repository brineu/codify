...
>>>>>>> origin/laravel:resources/views/quis/SDT/quizs4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Apa output dari len([1, 2, 3, 4])?</p>
    </div>
