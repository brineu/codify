...
<<<<<<< HEAD:codify/html/quis/mandat/quizma9.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma9.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Perintah SQL untuk memperbarui data dalam tabel adalah?</p>
    </div>
