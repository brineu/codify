...
<<<<<<< HEAD:codify/html/quis/mandat/quizma2.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma2.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma2.blade.php
    ...
    <div class="question">
        <p class="question-text">2. Manakah dari berikut yang bukan merupakan jenis perintah SQL?</p>
    </div>
