...
<<<<<<< HEAD:codify/html/quis/mandat/quizma1.html
    <link rel="stylesheet" href="/codify/css/quiz/quis1.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quis1.css') }}">
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma1.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma1.blade.php
    ...
    <div class="question">
        <p class="question-text">1. Apa singkatan dari SQL?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Simple Query Language</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Structured Query Language</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Sequential Query Language</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">System Query Language</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <form action="{{ route('quiz.pydb', ['quizNumber' => $quizNumber + 1]) }}">
