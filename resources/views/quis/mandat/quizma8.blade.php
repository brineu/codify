...
<<<<<<< HEAD:codify/html/quis/mandat/quizma8.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma8.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/mandat/quizma8.blade.php
    ...
    <div class="question">
        <p class="question-text">8. Fungsi SQL COUNT() digunakan untuk?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Menghitung jumlah baris</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Menjumlahkan nilai kolom</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Mengelompokkan data</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Menggabungkan tabel</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
