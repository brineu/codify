...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/html/quizh6.html
...
>>>>>>> origin/laravel:resources/views/quis/html/quizh6.blade.php
    ...
    <div class="question">
        <p class="question-text">6. Apa yang dimaksud dengan HTML5?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Gaya penulisan HTML yang baru</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Bahasa pemrograman HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
