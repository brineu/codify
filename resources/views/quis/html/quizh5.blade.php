...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/html/quizh5.html
...
>>>>>>> origin/laravel:resources/views/quis/html/quizh5.blade.php
    ...
    <div class="question">
        <p class="question-text">5. Apa yang dimaksud dengan elemen HTML?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Bagian terpenting dari halaman web</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Setiap tag dalam HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Gaya penulisan HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
