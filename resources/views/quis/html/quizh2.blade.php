...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/html/quizh2.html
...
>>>>>>> origin/laravel:resources/views/quis/html/quizh2.blade.php
    ...
    <div class="question">
        <p class="question-text">2. HTML berfungsi untuk?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Menyusun halaman web</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Menyajikan data</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
