...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/html/quizh3.html
...
>>>>>>> origin/laravel:resources/views/quis/html/quizh3.blade.php
    ...
    <div class="question">
        <p class="question-text">3. Apa yang dimaksud dengan "DOCTYPE" dalam HTML?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Versi terbaru dari HTML</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Tag untuk membuat daftar dokumen HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Penanda untuk menentukan versi HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Format file gambar dalam HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
