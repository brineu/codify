...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/html/quizh4.html
...
>>>>>>> origin/laravel:resources/views/quis/html/quizh4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Apa yang dimaksud dengan atribut HTML?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Sebuah tag dalam HTML</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Data yang disematkan dalam tag</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Menentukan karakteristik elemen HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Bagian dari body HTML</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
