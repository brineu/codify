...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/FM/quizf3.html
...
>>>>>>> origin/laravel:resources/views/quis/FM/quizf3.blade.php
    ...
    <div class="question">
        <p class="question-text">3. Parameter fungsi digunakan untuk apa?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Mengontrol looping</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
