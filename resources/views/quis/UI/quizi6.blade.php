...
>>>>>>> origin/laravel:resources/views/quis/UI/quizi6.blade.php
    ...
    <div class="question">
        <p class="question-text">6. Dalam desain grafis, CMYK digunakan terutama untuk?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Desain web</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Desain cetak</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Desain logo</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Desain animasi</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
