...
>>>>>>> origin/laravel:resources/views/quis/UI/quizi2.blade.php
    ...
    <div class="question">
        <p class="question-text">2. Apa yang dimaksud dengan "Feedback" dalam UI?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Respons sistem terhadap aksi pengguna</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Balasan dari pengguna terhadap UI</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Merekam aktivitas pengguna</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
