...
>>>>>>> origin/laravel:resources/views/quis/UI/quizi4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Manakah yang bukan merupakan elemen desain grafis?</p>
    </div>
