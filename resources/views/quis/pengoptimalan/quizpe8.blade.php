...
<<<<<<< HEAD:codify/html/quis/pengoptimalan/quizpe8.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe8.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe8.blade.php
    ...
    <div class="question">
        <p class="question-text">8. Apa kegunaan "profiler" dalam konteks pengukuran performa Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Mengevaluasi desain database</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Memantau aktivitas pengguna</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
