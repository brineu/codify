...
<<<<<<< HEAD:codify/html/quis/pengoptimalan/quizpe5.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe5.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe5.blade.php
    ...
    <div class="question">
        <p class="question-text">5. Apa yang diukur oleh modul "gc" dalam Python?</p>
    </div>
