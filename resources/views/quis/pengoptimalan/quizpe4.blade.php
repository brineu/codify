...
<<<<<<< HEAD:codify/html/quis/pengoptimalan/quizpe4.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe4.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Apa itu "profiling" dalam konteks pemrograman Python?</p>
    </div>
