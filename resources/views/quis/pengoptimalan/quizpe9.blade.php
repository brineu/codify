...
<<<<<<< HEAD:codify/html/quis/pengoptimalan/quizpe9.html
    <link rel="stylesheet" href="/codify/css/quiz/quiz2.css">
=======
    <link rel="stylesheet" href="{{ asset('/css/quiz/quiz2.css') }}">
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe9.blade.php
...
>>>>>>> origin/laravel:resources/views/quis/pengoptimalan/quizpe9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Apa yang diukur oleh modul "time" dalam Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Waktu eksekusi</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Penggunaan memori</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
