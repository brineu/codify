...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/dds/quizd4.html
...
>>>>>>> origin/laravel:resources/views/quis/dds/quizd4.blade.php
    ...
    <div class="question">
        <p class="question-text">4. Bagaimana Anda mendeklarasikan variabel di Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">x = variable</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
