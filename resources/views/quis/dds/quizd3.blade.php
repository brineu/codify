...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/dds/quizd3.html
...
>>>>>>> origin/laravel:resources/views/quis/dds/quizd3.blade.php
    ...
    <div class="question">
        <p class="question-text">3. Apa output dari print(2 + 3 * 4)?</p>
    </div>
