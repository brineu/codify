...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/dds/quizd8.html
...
>>>>>>> origin/laravel:resources/views/quis/dds/quizd8.blade.php
    ...
    <div class="question">
        <p class="question-text">8. Bagaimana Anda mengambil input dari pengguna di Python?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">get_input()</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">user_input()</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">read_input()</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
