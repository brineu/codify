...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/dds/quizd7.html
...
>>>>>>> origin/laravel:resources/views/quis/dds/quizd7.blade.php
    ...
    <div class="question">
        <p class="question-text">7. Apa output dari print("Hello" * 3)?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">"HelloHelloHello"</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">"Hello 3 times"</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">"HelloHello"</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
