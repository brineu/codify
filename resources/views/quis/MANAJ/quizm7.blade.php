...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/MANAJ/quizm7.html
...
>>>>>>> origin/laravel:resources/views/quis/MANAJ/quizm7.blade.php
    ...
    <div class="question">
        <p class="question-text">7. Apa yang dilakukan oleh metode os.rename()?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Mengganti nama file</span>
                </label>
            </div>
        </div>
