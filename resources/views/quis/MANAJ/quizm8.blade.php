...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/MANAJ/quizm8.html
...
>>>>>>> origin/laravel:resources/views/quis/MANAJ/quizm8.blade.php
    ...
    <div class="question">
        <p class="question-text">8. Apa yang dilakukan oleh metode file.flush()?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Membersihkan kursor file</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Membersihkan buffer file</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Membersihkan isi file</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-4">
                    <span class="gender">Membersihkan metadata file</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
