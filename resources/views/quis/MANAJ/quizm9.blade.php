...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/MANAJ/quizm9.html
...
>>>>>>> origin/laravel:resources/views/quis/MANAJ/quizm9.blade.php
    ...
    <div class="question">
        <p class="question-text">9. Apa yang dilakukan oleh metode `os.path.join()`?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">Menggabungkan dua path</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">Menggabungkan dua file</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">Menggabungkan dua direktori</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <script>
        ...
        function goToNextPage() {
            var nextUrl = "{{ route('quiz.pymanaj', ['quizNumber' => $quizNumber + 1]) }}";
