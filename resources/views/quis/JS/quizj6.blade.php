...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/JS/quizj6.html
...
>>>>>>> origin/laravel:resources/views/quis/JS/quizj6.blade.php
    ...
    <div class="question">
        <p class="question-text">6. Apa output dari 'console.log(2 + "2")'?</p>
    </div>
