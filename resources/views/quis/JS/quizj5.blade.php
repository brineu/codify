...
<body>
    <div class="navbar">
<<<<<<< HEAD:codify/html/quis/JS/quizj5.html
...
>>>>>>> origin/laravel:resources/views/quis/JS/quizj5.blade.php
    ...
    <div class="question">
        <p class="question-text">5. Bagaimana cara membuat objek JavaScript?</p>
    </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-1">
                    <span class="gender">'var obj = new Object();'</span>
                </label>
            </div>
        </div>
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-2">
                    <span class="gender">'var obj = {}'</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
    ...
    <div class="options-box">
        <div class="options">
            ...
            <div class="category">
                <label for="dot-3">
                    <span class="gender">'var obj = Object.create();'</span>
                </label>
            </div>
        </div>
        <!-- Tambahkan opsi jawaban lainnya di sini -->
